 ...
 */
final class Version20230502122756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_address ALTER postal_code TYPE VARCHAR(10)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE report ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE report ALTER updated_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE visited_url ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE user_product_order_point_history ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE loyality_reward ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE user_payment ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE user_payment ALTER updated_at SET DEFAULT \'2023-05-02\'');
        $this->addSql('ALTER TABLE order_item ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE order_item ALTER updated_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE product ALTER updated_at TYPE VARCHAR(255)');
        $this->addSql('ALTER TABLE loyality_point ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE loyality_point ALTER updated_at SET DEFAULT \'2023-05-02\'');
        $this->addSql('ALTER TABLE user_card_ranking_history ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE user_order ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE "user" ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE "user" ALTER updated_at SET DEFAULT \'2023-05-02\'');
        $this->addSql('ALTER TABLE user_account_status_history ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE user_address_history ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
        $this->addSql('ALTER TABLE user_address ALTER postal_code TYPE VARCHAR(8)');
        $this->addSql('ALTER TABLE user_address ALTER created_at SET DEFAULT \'2023-05-02 11:02:45.120587\'');
    }
}
