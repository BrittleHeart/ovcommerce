 ...
 */
final class Version20230410100635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, loyality_card_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(30) NOT NULL, status INT DEFAULT 5 NOT NULL, last_login TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_email_verified BOOLEAN DEFAULT false NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, updated_at DATE DEFAULT \'now()\' NOT NULL, uuid VARCHAR(36) NOT NULL, PRIMARY KEY(id))');
