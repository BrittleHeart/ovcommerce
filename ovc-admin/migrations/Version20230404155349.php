 ...
 */
final class Version20230404155349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE loyality_card (id INT NOT NULL, card_type INT DEFAULT 1 NOT NULL, card_number VARCHAR(16) NOT NULL, issue_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expiration_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE loyality_reward (id INT NOT NULL, points_required INT NOT NULL, reward_type INT NOT NULL, reward_value INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN loyality_reward.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE opinion (id INT NOT NULL, by_user_id INT NOT NULL, product_id INT NOT NULL, product_rate INT NOT NULL, product_comment VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, loyality_card_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(30) NOT NULL, status INT DEFAULT 5 NOT NULL, last_login TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_email_verified BOOLEAN DEFAULT false NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, updated_at DATE DEFAULT \'now()\' NOT NULL, PRIMARY KEY(id))');
